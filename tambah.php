...
<body class="h-vh-100 bg-brandColor2">
    ...
    <form action="" method="post" enctype="multipart/form-data">
		...
		<td><label for="nama">Nama</label></td> <td></td>
            <br><input type="text" id="nama" name="nama" placeholder="Nama Lengkap" required>
        </div>
			<div class="form-group cell-10  offset-5">
            <td><label for="nim">Nim</label></td> <td></td>
            <br><input type="text" id="nim" name="nim" placeholder="Nomer Induk Mahasiswa" required>
        </div>
           <div class="form-group cell-10  offset-5">
            <td><label for="email">Email</label></td> <td></td>
            <br><input type="text" id="email" name="email" placeholder="Alamat Email" required>
        </div>
			 <div class="form-group cell-10  offset-5">
            <td><label for="jurusan">Jurusan </label></td> <td></td>
            <br><input type="text" id="jurusan" name="jurusan" placeholder="Jurusan" required>
        </div>
           <div class="form-group cell-10  offset-5">
