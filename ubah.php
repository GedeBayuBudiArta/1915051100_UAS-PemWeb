...
<body class="h-vh-100 bg-brandColor2">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group cell-10  offset-5">
            ...
            <br><input type="text" id="nama" name="nama" placeholder="Nama Lengkap" required value="<?php echo $mhs["nama"]; ?>">
        </div>

        <div class="form-group cell-10  offset-5">
            <label for="Nim">Nim :</label>
            <br><input type="text" id="nim" name="nim" placeholder="Nomer Induk Mahasiswa" required value="<?php echo $mhs["nim"]; ?>">
        </div>
        <div class="form-group cell-10  offset-5">
            <label for="email">Email </label>
            <br><input type="text" id="email" name="email" placeholder="Alamat Email" required value="<?php echo $mhs["email"]; ?>">
        </div>
        <div class="form-group cell-10  offset-5">
            <label for="jurusan">Jurusan </label>
            <br><input type="text" id="jurusan" name="jurusan" placeholder="Program Studi" required value="<?php echo $mhs["jurusan"]; ?>">
        </div>
        <div class="form-group cell-10  offset-5">
		...
		<div class="form-group cell-6  offset-3">
            ...
            <br><input type="file" id="gambar" name="gambar" placeholder="Foto Profil">
        </div>
        <div class="form-group cell-10  offset-5">
